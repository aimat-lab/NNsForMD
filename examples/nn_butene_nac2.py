...
from pyNNsMD.hypers.hyper_mlp_nac2 import DEFAULT_HYPER_PARAM_NAC as hyper
...
# If GPU available.
fit_error = nn.fit(["training_mlp_nac2"]*2, fit_mode="training", gpu_dist=[0, 0], proc_async=True)
print(fit_error)
