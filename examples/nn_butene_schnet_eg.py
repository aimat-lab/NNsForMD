...
from pyNNsMD.hypers.hyper_schnet_eg import DEFAULT_HYPER_PARAM_SCHNET_EG as hyper
...
ensemble_path = "TestEnergyGradientSchnet/"
...
fit_error = nn.fit(["training_schnet_eg"]*2, fit_mode="training", gpu_dist=[0, 0], proc_async=False)
print(fit_error)
