...
from pyNNsMD.hypers.hyper_schnet_kgcnn_e import DEFAULT_HYPER_PARAM_SCHNET_KGCNN_E as hyper
...
ensemble_path = "TestEnergySchnetKGCNN/"
...
fit_error = nn.fit(["training_schnet_kgcnn_e"]*2, fit_mode="training", gpu_dist=[0, 0], proc_async=False)
print(fit_error)
