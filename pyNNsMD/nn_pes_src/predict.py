...
from pyNNsMD.nn_pes_src.predicting.predict_mlp_nac import _predict_uncertainty_mlp_nac
from pyNNsMD.nn_pes_src.predicting.predict_mlp_eg import _predict_uncertainty_mlp_eg
